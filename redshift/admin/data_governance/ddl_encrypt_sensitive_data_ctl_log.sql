-- public.encrypt_sensitive_data_ctl_log definition

-- Drop table

--DROP TABLE public.encrypt_sensitive_data_ctl_log;


CREATE TABLE IF NOT EXISTS public.encrypt_sensitive_data_ctl_log
(
...
DISTSTYLE AUTO
;
ALTER TABLE public.encrypt_sensitive_data_ctl_log owner to qadbadmin;

-- Permissions

GRANT INSERT, SELECT, UPDATE, DELETE, RULE, REFERENCES, TRIGGER ON TABLE public.encrypt_sensitive_data_ctl_log TO qadbadmin;
GRANT SELECT ON TABLE public.encrypt_sensitive_data_ctl_log TO looker;
