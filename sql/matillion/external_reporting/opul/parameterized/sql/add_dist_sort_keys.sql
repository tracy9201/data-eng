...
ALTER TABLE dwh_opul${environment}.dim_customer
ALTER DISTSTYLE KEY DISTKEY gx_customer_id ;


ALTER TABLE dwh_opul${environment}.dim_practice
ALTER DISTSTYLE ALL;

ALTER TABLE dwh_opul${environment}.dim_staff
ALTER DISTSTYLE ALL;

ALTER TABLE dwh_opul${environment}.dim_p2pe_device
ALTER DISTSTYLE ALL;

ALTER TABLE dwh_opul${environment}.fact_product_sales
ALTER DISTSTYLE KEY DISTKEY k_customer_id ;


ALTER TABLE dwh_opul${environment}.fact_payment_summary
ALTER DISTSTYLE KEY DISTKEY gx_customer_id;

ALTER TABLE dwh_opul${environment}.fact_batch_report_summary
...
ALTER TABLE dwh_opul${environment}.fact_batch_report_details
