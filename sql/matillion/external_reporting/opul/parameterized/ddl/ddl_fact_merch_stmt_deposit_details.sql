DROP TABLE IF EXISTS dwh_opul${environment}.fact_merch_stmt_deposit_details;

CREATE TABLE IF NOT EXISTS dwh_opul${environment}.fact_merch_stmt_deposit_details
(
