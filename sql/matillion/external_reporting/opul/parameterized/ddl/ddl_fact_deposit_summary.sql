...
( reference_id VARCHAR(255) ENCODE raw
  ...
  ,funding_instruction_date  TIMESTAMP WITHOUT TIME ZONE ENCODE raw
  ...
  ,epoch_funding_instruction_date BIGINT ENCODE raw
...
DISTKEY(merchant_id)  
SORTKEY(merchant_id, settled_at_date, funding_instruction_date);