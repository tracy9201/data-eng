DROP TABLE IF EXISTS dwh_opul.fact_merch_stmt_deposit_transaction_details;
CREATE TABLE IF NOT EXISTS  dwh_opul.fact_merch_stmt_deposit_transaction_details 
(
