DROP TABLE IF  EXISTS ir_opul.dim_practice_odf_mapping;

CREATE TABLE IF NOT EXISTS ir_opul.dim_practice_odf_mapping
(
    ...
    ,mid_type VARCHAR(32) ENCODE raw
    ,store_number VARCHAR(32) ENCODE raw
    ,merchant_category_code VARCHAR(32) ENCODE raw
